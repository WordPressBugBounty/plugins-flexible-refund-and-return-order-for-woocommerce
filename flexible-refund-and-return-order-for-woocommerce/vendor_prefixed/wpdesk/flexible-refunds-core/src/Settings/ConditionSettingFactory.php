...
class ConditionSettingFactory
{
    ...
    public function get_user_roles_select(array $data): string
    {
        ...
        $field = (new SelectField())->set_name('user_roles')->set_options($roles)->add_class('wc-enhanced-select')->set_multiple();
    ...
    public function get_order_statuses_select(array $data): string
    {
        ...
        unset($order_statuses['wc-cancelled'], $order_statuses[RegisterOrderStatus::REQUEST_REFUND_STATUS], $order_statuses['wc-failed'], $order_statuses['wc-refunded']);
        $field = (new SelectField())->set_name('order_statuses')->set_options($order_statuses)->add_class('wc-enhanced-select')->set_multiple();
        return $this->renderer->render($field->should_override_form_template() ? $field->get_template_name() : 'form-field', ['field' => $field, 'renderer' => $this->renderer, 'name_prefix' => $this->get_prefix($data['index']), 'value' => $data['value'], 'template_name' => $field->get_template_name()]);
    }
    /**
     * @param array $data
    ...
    public function get_payment_methods_select(array $data): string
    {
        ...
        $field = (new SelectField())->set_name('payment_methods')->set_options($enabled_gateways)->add_class('wc-enhanced-select')->set_multiple();
        return $this->renderer->render($field->should_override_form_template() ? $field->get_template_name() : 'form-field', ['field' => $field, 'renderer' => $this->renderer, 'name_prefix' => $this->get_prefix($data['index']), 'value' => $data['value'], 'template_name' => $field->get_template_name()]);
    }
    /**
     * @param array $data
    ...
    public function get_product_cats_select(array $data): string
    {
        ...
        $field = (new SelectField())->set_name('product_cats')->set_options($items)->add_class('wc-enhanced-select')->set_multiple();
        return $this->renderer->render($field->should_override_form_template() ? $field->get_template_name() : 'form-field', ['field' => $field, 'renderer' => $this->renderer, 'name_prefix' => $this->get_prefix($data['index']), 'value' => $data['value'], 'template_name' => $field->get_template_name()]);
    }
    /**
     * @param array $data
    ...
    public function get_products_select(array $data): string
    {
        ...
        $field = (new SelectField())->set_name('products')->set_options($items)->add_class('wc-product-search')->set_attribute('data-action', 'woocommerce_json_search_products_and_variations')->set_multiple();
        return $this->renderer->render($field->should_override_form_template() ? $field->get_template_name() : 'form-field', ['field' => $field, 'renderer' => $this->renderer, 'name_prefix' => $this->get_prefix($data['index']), 'value' => $data['value'], 'template_name' => $field->get_template_name()]);
    }
}
