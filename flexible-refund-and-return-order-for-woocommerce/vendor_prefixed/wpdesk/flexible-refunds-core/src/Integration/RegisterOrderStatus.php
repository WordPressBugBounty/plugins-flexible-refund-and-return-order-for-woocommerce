...
class RegisterOrderStatus implements Hookable
{
    ...
    {
        register_post_status(self::REQUEST_REFUND_STATUS, [
            'label' => esc_html__('Request', 'flexible-refund-and-return-order-for-woocommerce'),
            'public' => \true,
            'exclude_from_search' => \false,
            'show_in_admin_all_list' => \true,
            'show_in_admin_status_list' => \true,
            /* translators: %s: number of requests. */
            'label_count' => _n_noop('Request <span class="count">(%s)</span>', 'Requests <span class="count">(%s)</span>', 'flexible-refund-and-return-order-for-woocommerce'),
        ]);
    }
    /**
    ...
    {
        $statuses[self::REQUEST_REFUND_STATUS] = esc_html__('Request', 'flexible-refund-and-return-order-for-woocommerce');
        return $statuses;
    }
