...
class EmailRefundRequested extends AbstractRefundEmail
{
    ...
    {
        return wpautop(wp_kses(__("Hi {customer_name},\n\nThank you for your return request! Your refund request was submitted on {refund_request_date}. We will review it and let you know in the next email if a refund will be granted. <a href='{refund_url}' target='_blank'>Click here to cancel your refund</a>.\n\nBelow you will find a table with the products you requested to refund.\n\n{refund_order_table}\n\n{refund_info_page}\n\nSincerely,\nStore Team", 'flexible-refund-and-return-order-for-woocommerce'), EmailHelper::allowed_tags()));
    }
}
