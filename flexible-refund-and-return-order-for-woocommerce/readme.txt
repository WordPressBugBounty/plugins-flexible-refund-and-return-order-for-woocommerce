...
= 2.0.3 - 2026-09-23 =
* Removed refund type in email headers

= 2.0.2 - 2026-09-10 =
* Fixed the plugin settings page link

= 2.0.1 - 2026-08-25 =
* Added option to automatically refund shipping costs when all remaining products are returned
* Fixed refund request date formatting in email notifications

= 2.0.0 - 2026-08-19 =
* Support for refund, complaint, and repair requests, each with its own customizable form
* Multiple requests for the same order can now be viewed and managed independently
* Request type and status are now visible in the WooCommerce order list and email notifications
...
= 1.2.2 - 2026-07-14 =
* Fixed refund request status is now marked as paid

= 1.2.1 - 2026-07-08 =
* Fixed plugin requirements

= 1.2.0 - 2026-07-01 =
* Added refund support for Zero-value orders
...
= 1.0.35 - 2025-08-12 =
* Fixed error with deleted product on refund preview
...
= 1.0.25 - 2024-11-06 =
* Fixed placeholder for select field
